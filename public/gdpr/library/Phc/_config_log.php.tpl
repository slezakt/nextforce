 ...
 */
define('ERR_PROJECT_NAME','__PROJECT_NAME__');
 ...
 */
define('ERR_PROJECT_ID', __PROJECT_ID__);

/**
 * Email vyvojare
 */
define('ERR_EMAIL_DEVELOPER','__DEBUG_MAIL__');
define('DEVELOPER_EMAIL', '__DEBUG_MAIL__');
