<?
/**
 * iBulletin - View/Truncate.php
 *
 * skrati retezec po nejblizsi slovo a prilepi postfix
 * lze parametrizovat funkcemi postfix(), midword() a length()
 *
 */
class Ibulletin_View_Helper_Truncate extends Zend_View_Helper_Abstract {
