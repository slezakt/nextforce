    ...
    protected function _generateCFS()
    {
        ...
        foreach ($this->_files as $fileName) {
            ...
            while ($byteCount > 0) {
                ...
                /*
                 * PHC change - wrong counting of bytes if used multibyte encoding - sometimes
                 * function gets looped, but only on some enviroments.
                 */
                //$byteCount -= strlen($data);
                $byteCount -= mb_strlen($data, 'ISO-8859-1');
