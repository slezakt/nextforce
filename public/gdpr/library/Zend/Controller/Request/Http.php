...
class Zend_Controller_Request_Http extends Zend_Controller_Request_Abstract
{
    ...
    /**
     * PHC MODIFIED - added 'userland' 
     *
     * Allowed parameter sources
     * @var array
     */
    protected $_paramSources = array('userland', '_GET', '_POST');
    ...
    public function getParam($key, $default = null)
    {
        ...
        foreach($paramSources as $source){
            ...
            if(isset($GLOBALS[$source][$keyName])){
                return $GLOBALS[$source][$keyName];
            }
        }
        
        /*//ORIGINAL CODE BY ZEND
        if (isset($this->_params[$keyName])) {
            return $this->_params[$keyName];
     ...
     * PHC MODIFIED
     *
     * Retrieve an array of parameters according to sources and order of
     * sources set by setParamSources() method.
     *
     ...
     * METHOD ADDED BY PHC
     * 
     * Gets an array of parameters transfered in URL.
     * 
     * @return array    Parameters transferred in URL
     */
    public function getUrlParams(){
        $paramSources = $this->getParamSources();
        
        $this->setParamSources(array('userland'));
        
        $urlParams = $this->getParams();
        
        $this->setParamSources($paramSources);
