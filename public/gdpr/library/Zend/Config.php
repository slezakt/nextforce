...
class Zend_Config implements Countable, Iterator
{
     ...
     * PHC
     * 
     * Retrieve a value and return array created by exploding comma separated string
     * if no element is set, the $default is returned.
     *
     * @param string $name
     * @param mixed $default
     * @return array
     */
    public function getCommaSeparated($name, $default = null)
    {
        $result = $default;
