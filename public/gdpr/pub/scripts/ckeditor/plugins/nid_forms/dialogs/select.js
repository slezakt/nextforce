	...
	return {
		...
		onShow: function() {
			...
			this.fakeObj = false;
                        ...
                        if ( element && element.data( 'cke-real-element-type' ) && element.data( 'cke-real-element-type' ) == 'select' )
                        {
		...
		onOk: function() {
			var editor = this.getParentEditor(),
                        ...
                        // Insert a new select.
                        var fakeElement = editor.createFakeElement( element, 'cke_select', 'select',false );
                        if ( !this.editMode )
