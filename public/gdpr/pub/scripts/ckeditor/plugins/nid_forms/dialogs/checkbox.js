	...
	return {
		...
		onShow: function() {
			...
			var editor = this.getParentEditor(),
                        ...
                        if ( element && element.data( 'cke-real-element-type' ) && element.data( 'cke-real-element-type' ) == 'checkbox' )
                        {
                                this.checkbox = element;
                                element = editor.restoreRealElement( this.checkbox );
                                this.setupContent( element );
                                selection.selectElement( this.checkbox );
                        }
		...
		onOk: function() {
			...
			var name = this.getValueOf( 'info', 'txtName' ),
                        ...
                        if(isChecked)
                        {
                                var fakeElement = editor.createFakeElement( element, 'cke_checkbox_checked', 'checkbox' );
                        }else
                        {
                                var fakeElement = editor.createFakeElement( element, 'cke_checkbox', 'checkbox' );
                        }
                        ...
                        {
                                fakeElement.replace( this.checkbox );
