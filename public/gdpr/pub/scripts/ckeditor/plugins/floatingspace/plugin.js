                ...
                var config = editor.config,
                        ...
                        layout = (function() {
                            ...
                            function changeMode(newMode) {
                                ...
                                var scale = 1;
                                if (typeof pmakerAdmin.scale !== "undefined") {
                                    scale = pmakerAdmin.scale;
                                }

                                switch (newMode) {
                                    case 'top':
                                        updatePos('absolute', 'top', (editorPos.y * scale) - spaceHeight - dockedOffsetY);
                                        break;
                                    case 'pin':
                            ...
                            return function(evt) {
                                ...
                                var mid = viewRect.width / 2,
                                        ...
                                        :
                                        (mid - editorRect.left > editorRect.right - mid ? 'left' : 'left'),
                                        offset;
